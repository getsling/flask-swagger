...
class UserAPI(MethodView):
    ...
    def post(self):
        ...
        return {}
```
Flask-swagger supports docstrings in methods of MethodView classes (aka [Flask-RESTful](https://github.com/flask-restful/flask-restful)) and regular Flask view functions.
